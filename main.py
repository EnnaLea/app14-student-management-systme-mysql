...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create statusbar and add statusbar
    ...
    def cell_clicked(self):
        ...
        # clean any other buttons to statusbar
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app was created during the course "The Python Mega
        Course". Feel free to modify and reuse this app.
        """
